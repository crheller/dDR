...
nSamples = 100
krange = np.arange(10, 510, 10) #np.arange(10, 510, 10)
...
# plot results 
f, ax = plt.subplots(3, 3, figsize=(6.5, 6))
xpos = [0, 1, 2]
nevals = 20
eval_lim = 0.1
for tit, dim, x in zip(['1-D, high var.', '1-D, low var.', r'$\approx$ Indep. Noise'], d_full.keys(), xpos):
